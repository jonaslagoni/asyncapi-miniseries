...
export function subscribe(
  onDataCallback: (
    ...
    msg ? : PlayerUsedChatPayload, serverId ? : string, playerId ? : string) => void,
  ...
  return new Promise(async (resolve, reject) => {
    ...
    try {
      let subscription = await client.subscribe(`game.server.${serverId}.events.player.${playerId}.chat`, (err, msg) => {
        if (err) {
