 ...
 */
function publish(message, client, serverId, playerId, itemId) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield client.publish(`game.server.${serverId}.events.player.${playerId}.item.${itemId}.pickup`, dataToSend);
            resolve();
        }
        catch (e) {
