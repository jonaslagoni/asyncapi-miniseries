...
function subscribe(onDataCallback, client, serverId, playerId, options) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let subscription = yield client.subscribe(`game.server.${serverId}.events.player.${playerId}.connect`, (err, msg) => {
                if (err) {
...
//# sourceMappingURL=GameServerServerIdEventsPlayerPlayerIdConnect.js.map