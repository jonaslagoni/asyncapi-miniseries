 ...
 */
export declare function subscribe(onDataCallback: (err?: NatsTypescriptTemplateError, msg?: AnonymousSchema_9, serverId?: string, playerId?: string) => void, client: Client, serverId: string, playerId: string, options?: SubscriptionOptions): Promise<Subscription>;
