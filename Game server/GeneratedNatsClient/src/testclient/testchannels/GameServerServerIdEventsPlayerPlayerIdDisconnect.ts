...
export function subscribe(
  onDataCallback: (
    ...
    msg ? : PlayerDisconnectedPayload, serverId ? : string, playerId ? : string) => void,
  ...
  return new Promise(async (resolve, reject) => {
    ...
    try {
      let subscription = await client.subscribe(`game.server.${serverId}.events.player.${playerId}.disconnect`, (err, msg) => {
        if (err) {
