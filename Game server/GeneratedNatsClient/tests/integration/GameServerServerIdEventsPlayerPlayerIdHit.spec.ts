...
describe('game/server/{serverId}/events/player/{playerId}/hit can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    var receivedMsg: TestClient.AnonymousSchema_9 | undefined = undefined;
    var receivedServerId: string | undefined = undefinedvar receivedPlayerId: string | undefined = undefined
    var publishMessage: Client.AnonymousSchema_9 = {
    ...
    const subscription = await testClient.subscribeToGameServerServerIdEventsPlayerPlayerIdHit((err, msg, serverId, playerId) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToGameServerServerIdEventsPlayerPlayerIdHit(publishMessage, ServerIdToSend, PlayerIdToSend);
